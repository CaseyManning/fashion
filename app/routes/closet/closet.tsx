...
type ClothingCategory = (typeof schema.category.enumValues)[number];
...
export async function loader() {
  ...
  const inCategories: Record<ClothingCategory, Clothing[]> = Object.fromEntries(
    schema.category.enumValues.map((key) => [key, [] as Clothing[]])
...
export default function ClosetList({ actionData }: Route.ComponentProps) {
  ...
  const filledCategories = schema.category.enumValues.filter(
